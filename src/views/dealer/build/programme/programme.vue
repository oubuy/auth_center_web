...
<keep-alive include="listView">
    ...
    <edit-view is="editView" v-if="view=='edit'" :programmeId="programmeId" @goto-list="handleGotoList"></edit-view>
</keep-alive>
</template>

<script>
import listView from "@/views/dealer/build/programme/programme-list";
