<template>
    <div>
        ...
        <Upload v-show="uploadList.length<10" ref="upload" action="/rest/outerUser/uploadImage" multiple :headers="uploadHeaders" type="drag" name="file" :show-upload-list="false" :format="uploadImgFormat" :on-success="handleSuccess" :on-format-error="handleFormatError" :before-upload="handleBeforeUpload" class="upload">
        ...
        methods: {
            ...
            handleSuccess(res, file) {
                if (res.code == 200) {
                    ...
                    this.$emit("get-img",this.uploadList);
                } else {
